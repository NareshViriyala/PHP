DROP PROCEDURE IF EXISTS dbo.usp_add_UserDeviceErrorLog;

DELIMITER $$
CREATE PROCEDURE dbo.usp_add_UserDeviceErrorLog(_input TEXT)
BEGIN
	DECLARE itemCount INT DEFAULT ExtractValue(_input, 'count(//DeviceID)');
    SET @MaxID := 1;
    
    WHILE @MaxID <= itemCount DO
		INSERT INTO dbo.tbl_UserDeviceErrorLog(DeviceID,PageName,MethodName,ExceptionType,ExceptionText,OcrDate)
...
#CALL dbo.usp_add_UserDeviceErrorLog('2968491D-75BB-4C48-8F16-E789EE44860E', NULL, 2, 10);
