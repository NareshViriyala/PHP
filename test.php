...
<?php 
	$driverinfoarray = json_decode(@file_get_contents($webserviceurl.'GetDoctorDetails.php?id=11'), true);
	$driverimage = @file_get_contents($webserviceurl.'GetDoctorImage.php?id=11');
	$driveraverage = @file_get_contents($webserviceurl.'GetAutoDriverFeedback.php?id=11&gettype=Average');
	$driverhistory = @file_get_contents($webserviceurl.'GetAutoDriverFeedback.php?id=11&gettype=History');
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://www.jqchart.com/jquery/chart/Content/themes/le-frog/jquery-ui-1.10.4.min.css" />
    <script src="http://www.jqchart.com/jquery/chart/Scripts/jquery-1.11.1.min.js" type="text/javascript"></script>
    ...
    <script lang="javascript" type="text/javascript">
        ...
        var data4 = [];
		var data5 = [];
		var data0 = <?php echo $driverhistory; ?>;
        ...
        for (var i = 0; i < data0.length; i++) {
            data1.push([data0[i]['FBDate'], data0[i]['Politeness']]);
			data2.push([data0[i]['FBDate'], data0[i]['Driving']]);
        }
		console.log(data1);
		*/
		for (var i = 0; i < 200; i++) {
...
<body>
    <div>
        <div id="jqChart" style="width: 100%; height: 30%;">
        </div>
    </div>
</body>
</html>